...
import { Calculator, DollarSign, Percent, Clock, ChevronDown } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Use our calculator to estimate your monthly car payment. Adjust the values to see different scenarios.
            </p>
          </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setInterestRate(creditScoreRates[e.target.value].rate)
                  }}
